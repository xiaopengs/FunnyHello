...
import com.xiaopeng.funnyhello.adapter.LoaderAdapter;
import com.xiaopeng.funnyhello.cache.ImageLoader;
...
public class AsyncListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_async_list);
        setupViews();
    }
    ...
    private static final String[] URLS = {
            "http://img1.imgtn.bdimg.com/it/u=151777634,1397517941&fm=21&gp=0.jpg",
            "http://img3.imgtn.bdimg.com/it/u=3939496058,2848670555&fm=21&gp=0.jpg",
            "http://img5.imgtn.bdimg.com/it/u=1039667765,364201626&fm=21&gp=0.jpg",
            "http://img5.imgtn.bdimg.com/it/u=1990414695,655168922&fm=21&gp=0.jpg",
            "http://img3.imgtn.bdimg.com/it/u=900191222,3297472123&fm=21&gp=0.jpg",
            "http://img2.imgtn.bdimg.com/it/u=2677909480,3127299686&fm=21&gp=0.jpg",
